...
namespace guoShuai.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        public static void GenerateCodeFile(DataTableProcessor dataTableProcessor, string dataTableName)
        {
            ...
            string csharpCodeFileName = Utility.Path.GetRegularPath(Path.Combine(CSharpCodePath, "DB" + dataTableName + ".cs"));
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "guoShuai");
            codeContent.Replace("__DATA_TABLE_CLASS_NAME__", "DB" + dataTableName);
