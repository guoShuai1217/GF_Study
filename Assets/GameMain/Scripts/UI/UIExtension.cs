...
namespace guoShuai
{
    public static class UIExtension
    {
        ...
        public static bool HasUIForm(this UIComponent uiComponent, FormEnum uiFormId, string uiGroupName = null)
        {
        ...
        {
            IDataTable<DBUIForm> dtUIForm = Game.DataTable.GetDataTable<DBUIForm>();
            DBUIForm drUIForm = dtUIForm.GetDataRow(uiFormId);
            if (drUIForm == null)
            {
                return false;
            }
        ...
        public static UGuiForm GetUIForm(this UIComponent uiComponent, FormEnum uiFormId, string uiGroupName = null)
        {
        ...
        public static int? OpenUIForm(this UIComponent uiComponent, FormEnum uiFormId, object userData = null)
        {
        ...
        public static void OpenDialog(this UIComponent uiComponent, DialogParams dialogParams)
        {
            ...
            //else
            {
                uiComponent.OpenUIForm(FormEnum.DialogForm, dialogParams);
            }
        }
